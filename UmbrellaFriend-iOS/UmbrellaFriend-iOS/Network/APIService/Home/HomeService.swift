...
//    // MARK: - GET
//    func getHome(completion: @escaping(GeneralResponse<HomeDto>?) -> Observable<HomeDto>) {
//        homeProvider.request(.getHome) { [weak self] result in
//                guard let self = self else { return }
//                switch result {
//                case .success(let response):
//                    do {
//                        let homeResponse = try response.map(GeneralResponse<HomeDto>.self)
//                        guard let homeDto = homeResponse.data else {
//                            completion(nil)
//                            return
//                        }
//                        completion(homeDto)
